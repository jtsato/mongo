...
public class JavaSimpleExample {
    ...
    public static void main(String[] args) throws UnknownHostException{
        ...
        MongoClientURI uri  = new MongoClientURI("mongodb://admin:admin@localhost:27017/admin");
        ...
        Document document = Document.parse("{'decade':'2000s', 'artist': 'Metallica', 'song': 'Enter Sandman', weeksAtOne : 99 }");
